...
export const trackingData = pgTable("tracking_data", {
  ...
  vitals: json("vitals").$type<{
    temperature: number,
    heart_rate: number,
    activity_level: string
  }>(),
  safe_zone_radius: integer("safe_zone_radius"),
  is_within_safe_zone: boolean("is_within_safe_zone").default(true),
  movement_history: json("movement_history").$type<{
    timestamp: string,
    location: string
  }[]>(),
