...
const PetTracking = () => {
  ...
  const [currentLocation, setCurrentLocation] = useState({ lat: 14.5995, lng: 120.9842 }); // Manila, Philippines
  ...
  useEffect(() => {
    ...
    // Set initial path history with Manila area coordinates
    const manilaAreaCoordinates = [
      { lat: 14.5995, lng: 120.9842 }, // Manila
      { lat: 14.5996, lng: 120.9850 },
      { lat: 14.5990, lng: 120.9855 },
      { lat: 14.5985, lng: 120.9860 },
      { lat: 14.5980, lng: 120.9865 }
    ];
    setPathHistory(manilaAreaCoordinates);
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-medium">Rizal Park</h3>
                  <p className="text-gray-500 text-sm">200 meter radius</p>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-medium">BGC Pet Park</h3>
                  <p className="text-gray-500 text-sm">150 meter radius</p>
                </div>
              </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3 p-3 bg-yellow-50 border-l-4 border-yellow-500 rounded-r-lg">
              ...
              <div>
                <p className="font-medium">Left safe zone "Rizal Park"</p>
            ...
            <div className="flex items-start space-x-3 p-3 bg-green-50 border-l-4 border-green-500 rounded-r-lg">
              ...
              <div>
                <p className="font-medium">Entered safe zone "BGC Pet Park"</p>
